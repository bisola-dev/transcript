      ...
      <?php require_once('hedad2.php');?>
            ...
            <div class="page-wrapper">
              ...
              <form method="post" action="" enctype="multipart/form-data"  id="myCoolForm">
                ...
                <h3 class="page-title">Please enter your transcript request details for Student Copy </h3>
									<div class="form-group">
											<label> Transcript Type  (please note that this copy will be sent to your student email, ensure it is accessible or simply update email) <span class="text-danger">*</span></label>
                                            <select id="ttp" name=ttp class="form-control" required>                                    
                                            <option value="1">Studentcopy</option>
                                             </select>
                                            </disabled>
                                             </div>
								        	</div>
