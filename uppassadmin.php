...
$allowTypes = array('jpg','png','jpeg');
 if (!in_array($fileType, $allowTypes)){
      ...
      $insert= mysqli_query($conn, "UPDATE adminlogin SET logo = '$fileName' WHERE id = $schid");
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
							<h3 class="page-title">Upload or replace <?php echo $schname;?> logo.</h3>
						 ...
						 <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget"> 
								<div class="profile-img">
									 ...
									 <a href="#"> <img width="70px" src= <?php if($logoz==null){echo "olly/default.jpg";} else{echo"olly/$logoz";
					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Upload or replace  logo</h5>
