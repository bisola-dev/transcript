...
v<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from thememinister.com/crm/jpost.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Aug 2019 13:28:48 GMT -->
  <head>
    <meta charset="utf-8" />
    ...
    <!-- jquery-ui css -->
    <link
      href="assets/plugins/jquery-ui-1.12.1/jquery-ui.min.css"
      rel="stylesheet"
      type="text/css" />
    <!-- Bootstrap -->
    <link
    ...
    <!-- Lobipanel css -->
    <link
      href="assets/plugins/lobipanel/lobipanel.min.css"
      rel="stylesheet"
      type="text/css" />
    <!-- Pace css -->
    <link
      href="assets/plugins/pace/flash.css"
      rel="stylesheet"
      type="text/css" />
    <!-- Font Awesome -->
    <link
    ...
    <!-- Theme style -->
    <link
      href="assets/dist/css/stylecrm.css"
      rel="stylesheet"
      type="text/css" />
    <!-- Theme style rtl -->
  ...
  <body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown messages-menu">
                <a
                  href="#"
                  class="dropdown-toggle admin-notification"
                    ...
                    <ul class="menu">
                      <li>
                        ...
                        <a href="#" class="border-gray">
                          <div class="pull-left">
                            <img
                              src="assets/dist/img/basketball-jersey.png"
                              class="img-thumbnail"
                              alt="User Image" />
                          </div>
                          <h4>polo shirt</h4>
                      ...
                      <li>
                        <a href="#" class="border-gray">
                          <div class="pull-left">
                            <img
                              src="assets/dist/img/football.png"
                              class="img-thumbnail"
                              alt="User Image" />
                          </div>
                          <h4>Football</h4>
                ...
                <ul class="dropdown-menu">
                  <li>
                    <ul class="menu">
                      <li>
                        <a href="#" class="border-gray">
                          <i class="fa fa-dot-circle-o color-green"></i>Change
                          Your font style</a
                        >
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="#" class="border-gray">
                          <i class="fa fa-dot-circle-o color-violet"></i> Add
                          more clients and order</a
                        >
                      </li>
                      <li>
                        <a href="#" class="border-gray">
                    ...
                    <ul class="menu">
                      <li>
                        ...
                        <a href="#" class="border-gray">
                          ...
                          >
                          <h3>
                            <i class="fa fa-check-circle"></i> Theme color
                            should be change
                          </h3>
                        </a>
                      </li>
                      ...
                      <li>
                        ...
                        <a href="#" class="border-gray">
                          ...
                          >
                          <h3>
                            <i class="fa fa-check-circle"></i> Fix Error and
                            bugs
                          </h3>
                        </a>
                      </li>
                      ...
                      <li>
                        ...
                        <a href="#" class="border-gray">
                          ...
                          <h3>
                            <i class="fa fa-check-circle"></i> Sidebar color
                            change
                          </h3>
                        </a>
                      </li>
                      ...
                      <li>
                        ...
                        <a href="#" class="border-gray">
                          ...
                          <h3>
                            <i class="fa fa-check-circle"></i> font-family
                            should be change
                          </h3>
                        </a>
                      </li>
                      <li>
                        ...
                        <a href="#" class="border-gray">
                          ...
                          >
                          <h3>
                            <i class="fa fa-check-circle"></i> Fix the database
                            Error
                          </h3>
                        </a>
                      </li>
                      <li>
                        ...
                        <a href="#" class="border-gray">
                          ...
                          <h3>
                            <i class="fa fa-check-circle"></i> data table data
                            missing
                          </h3>
                        </a>
                      </li>
              ...
              <li class="dropdown dropdown-help hidden-xs">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <a href="#"><i class="fa fa-bar-chart"></i> Settings</a>
                  </li>
                  <li>
                    <a href="login.html"> <i class="fa fa-wifi"></i> wifi</a>
                  </li>
                </ul>
              </li>
              <!-- user -->
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <div class="header-title">
            <h1>Job post</h1>
            <small>List of Job posted</small>
          </div>
        </section>
        <!-- Main content -->
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header modal-header-primary">
                  ...
                  <h3>
                    <i class="fa fa-users m-r-5"></i> Update Job post table
                  </h3>
                </div>
                <div class="modal-body">
                  <div class="row">
      ...
      <footer class="main-footer">
        <strong
          >Copyright &copy; 2016-2017 <a href="#">thememinister</a>.</strong
        >
        All rights reserved.
      </footer>
    </div>
