 ...
 if (!in_array($fileType, $allowTypes)){
      echo '<script type="text/javascript">
        alert("Incorrect file format.Sorry only jpeg, jpg and png files are allowed");
                   ...
                   // Check file size
  else if ($_FILES["foto"]["size"] > 100000) {
               echo '<script type="text/javascript">
                alert("Sorry, your image is too large. Must be maximum of 100KB in size")
                </script>';
            }
   ...
   $insert= mysqli_query($conn, "UPDATE applicants SET pix = '$fileName', pasyes=1 WHERE emal = '$mymal'");
							...
							<div class="modal-body">
								<form method="post" action="" enctype="multipart/form-data">
									<div class="form-group">
									 <label>Select passport (png, jpg or jpeg format allowed) 200 X 200 pixels recommended <span class="text-danger">*</span></label>
