<?php require_once("cann.php");
    ...
    $callbacka = 'settlepay.php?uid='.$id1.'&uidh='.$hid1.'&amtt='.$formtt;
      ...
      $result2=mysqli_query($conn, "INSERT INTO payform (lame, emal, amtt, sessn, dpaid) VALUES (
              '$fully', '$mymal', '$totally', '$sess', '{$date_reg}')") or die("Insert Error: ".mysqli_error());

         $logan = mysqli_query($conn, "UPDATE applicants SET pafom = 1 WHERE hemal = '$hmal'"); 

         $loga = mysqli_query($conn, "INSERT INTO logger (uzer, activity, timereg) 
        VALUES ('$mymal', 'Paid for application form successfully', '$date_reg')");  


      
       
        echo '<script type="text/javascript">
       alert("Your payment for online application form was successful. You can now proceed to fill the form.")
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								...
								<h4>Application form :: ₦<?php echo $formtt; ?>
									<br>
