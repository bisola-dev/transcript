<?php require_once("cann.php");
  ...
  if (isset($_POST['submit'])){
    $questionzx= mysqli_real_escape_string($conn, strip_tags($_POST['questionzx']));
    $answerzx = mysqli_real_escape_string($conn, strip_tags($_POST['answerzx']));


$acct = mysqli_query($conn, "SELECT * FROM faq WHERE questionzx='$questionzx'");
$num_rows = mysqli_num_rows($acct);

if ($num_rows == 1){
      echo'<script type="text/javascript">
     alert("Sorry,you can only send the same question once.");
        </script>'; }


 else{
  $mysqlux = mysqli_query($conn, "INSERT INTO faq (questionzx,answerzx)VALUES('$questionzx','$answerzx')");
      
 echo'<script type="text/javascript">
         alert("Congratulations! you have successfully submitted  your detail.")
        </script>';
...
$questionzx4= mysqli_real_escape_string($conn, strip_tags($_POST['questionzx4']));
$answerzx4 = mysqli_real_escape_string($conn, strip_tags($_POST['answerzx4']));


$mysqlux4= mysqli_query($conn, "UPDATE faq SET question='$questionzx4', answer='$answerzx4' WHERE id=$adminid3");
...
if(isset($_POST["delete"])){
    ...
    $sql = "DELETE FROM faq WHERE id  IN ($adminid3)";
    ...
    <body>
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
									...
									<div class="col-sm-6 col-md-12">
										<div class="form-group">
											<label>Question<span class="text-danger"></span></label>
												<input name="questionzx" type="text" maxlength="200"  class="form-control" required>
										</div>
									</div>
									...
									<div class="col-sm-6 col-md-12">
										<div class="form-group">
											<label>Answer<span class="text-danger"></span></label>
												...
												<textarea name="answerzx"  rows = "5" cols = "50" class="form-control" required> </textarea>
										</div>
										</div>
             ...
             $bisola = mysqli_query($conn, "SELECT * FROM faq ");
              $num=1;
                  while ($row = mysqli_fetch_assoc($bisola)) {
                    $ada = $row['id'];
                    $questionzx2=$row['questionzx'];
                    $answerzx2 = $row['answerzx'];
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo $num;?></td>
                                       <td><?php echo $questionzx2;?></td>
                                       <td><?php echo $answerzx2;?></td >
                        ...
                        <div class="modal-header">
                           ...
                           <form method="post" action="" >
									...
									<div class="col-sm-6 col-md-12">
										<div class="form-group">
											...
											<input type="hidden" name="adminid3" value="<?php echo $ada;?>" id ="adminid2">
												<input name="questionzx4" type="text" maxlength="200"  class="form-control" id= "question3" value="<?php echo $question2;?>" >
										</div>
									</div>
									...
									<div class="col-sm-6 col-md-12">
										...
										<textarea name="answerzx4"  rows = "5" cols = "50" class="form-control"  id="answer3" value="<?php echo $answer2;?>"></textarea>
										</div>
									</div>
                                    <div class="submit-section">
