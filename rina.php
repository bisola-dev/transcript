<?php require_once("cann.php");
  ...
  if (isset($_POST['submit'])){
    $cny= trim(strip_tags($_POST['cny']));
    $addy = trim(strip_tags($_POST['addy']));
    $cemail = trim(strip_tags($_POST['cemail']));
    $dla = trim(strip_tags($_POST['dla']));
    $dlapple = trim(strip_tags($_POST['dlapple']));
    $fck = trim(strip_tags($_POST['fck']));
    $utb = trim(strip_tags($_POST['utb']));
    $gplus= trim(strip_tags($_POST['gplus']));
    $linkin = trim(strip_tags($_POST['linkin']));
    $fon=trim(strip_tags($_POST['fon']));
    $aboutus=trim(strip_tags($_POST['aboutus']));
    $twit = trim(strip_tags($_POST['twit']));

 if ($cny == ""|| $linkin==""||$addy==""||$cemail==""||$dla==""||$dlapple==""||$fck==""||$utb==""||$gplus==""||$fon==""||$aboutus==""||$twit==""){
	echo'<script type="text/javascript">
	alert("please do not submit an empty record.")
   </script>';
 }
 else{
...
$adminid3= trim(strip_tags($_POST['adminid3']));
  $cny4=  trim(strip_tags($_POST['cny4']));
  $addy4 =  trim(strip_tags($_POST['addy4']));
  $cemail4 = trim(strip_tags($_POST['cemail4']));
  $dla4 =  trim(strip_tags($_POST['dla4']));
  $dlapple4 =  trim(strip_tags($_POST['dlapple4']));
  $fck4=  trim(strip_tags($_POST['fck4']));
  $utb4 =  trim(strip_tags($_POST['utb4']));
  $gplus4=  trim(strip_tags($_POST['gplus4']));
  $linkin4 =  trim(strip_tags($_POST['linkin4']));
  $fon4=  trim(strip_tags($_POST['fon4']));
  $aboutus4=  trim(strip_tags($_POST['aboutus4']));
  $twit4 =  trim(strip_tags($_POST['twit4']));
