<?php require_once("cann.php");
  ...
  if (isset($_POST['clok'])){ 
   ...
   $progix = mysqli_real_escape_string($conn, strip_tags($_POST['progi']));
     ...
     $mysqlux = mysqli_query($conn, "UPDATE applicants SET gend = '$gendx', dob = '$dobx', aje = $ajex, sname = '$snamex', oname = '$onamex', addy = '$addyx', orig = '$origx', lga = '$lgax', natn = '$natnx', nkin = '$nkinx', nkfon = '$nkfonx', disab = '$disabx', disadet = '$disadetx', marit = '$maritx', paname = '$panamex', paddy = '$paddyx', fon = '$fonx', pafon = '$pafonx', mysec = '$mysecx', olev = '$olevx', exmno = '$exmnox', exmyr = '$exmyrx', exmpd = '$exmpdx', olev2 = '$olevx2', exmno2 = '$exmnox2', exmyr2 = '$exmyrx2', exmpd2 = '$exmpdx2', jreg = '$jregx', jsco = $jscox, progi = '$progix', subform = 1 WHERE emal = '$mymal'"); 
            
       echo '<script type="text/javascript">
       alert("Successfully updated. Proceed to O level exam grades.")
       window.location.href="dashboardapp.php";
        </script>';   
   }
...
<head>
        ...
        <title>Application form <?php echo $gendx; ?></title>
									 ...
									 <div class="col-sm-6 col-md-3">
										<div class="form-group">
										 ...
										 <option value="<?php echo $lga1;?>">-- Select LGA--</option>
													<option value="Kogi East">Kogi East</option>
													<option value="Kogi West">Kogi West</option>
